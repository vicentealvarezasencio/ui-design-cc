...
3. **Check for existing design files:**
   - .planning/design/design-tokens.json → Tokens already defined
   - .planning/design/UI-SPEC.md → Specs already started
...
Create `.planning/design/ui-state/` directory and initialize:
...
<success_criteria>
- `.planning/design/UI-CONTEXT.md` created with platform/framework/constraints
