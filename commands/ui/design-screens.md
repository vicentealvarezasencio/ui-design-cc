...
Create or update `.planning/design/UI-SPEC.md`:
...
<success_criteria>
- `.planning/design/UI-SPEC.md` exists with screen inventory and navigation flows
- `.planning/design/screens/SCR-XX-*.md` files created for all screens
